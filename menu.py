...
from settings import token, user_encode_key, ORDER_LIDGEN_ID, CHATBOT_ORDER_CONTROLLER, ANSWER_TYPE_OK, GETUNIQ_PASSWORD, GETUNIQ_LOGIN, GETUNIQ_CONTROLLER, ORDER_CHATBOT_ID, GOOGLE_RESPONSE_TOKEN
